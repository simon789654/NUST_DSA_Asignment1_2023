...
public client class LibraryServiceBooksResponseCaller {
...
public client class LibraryServiceEmptyResponseCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendEmptyResponse(EmptyResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextEmptyResponse(ContextEmptyResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class LibraryServiceBooksListCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendBooksList(BooksList response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextBooksList(ContextBooksList response) returns grpc:Error? {
        return self.caller->send(response);
    }
